...
# data
`import "github.com/intfoundation/go-data"`
...
See <a href="https://github.com/intfoundation/go-data/blob/master/common_test.go">https://github.com/intfoundation/go-data/blob/master/common_test.go</a> to see
...
[binary.go](/src/github.com/intfoundation/go-data/binary.go) [bytes.go](/src/github.com/intfoundation/go-data/bytes.go) [docs.go](/src/github.com/intfoundation/go-data/docs.go) [json.go](/src/github.com/intfoundation/go-data/json.go) [wrapper.go](/src/github.com/intfoundation/go-data/wrapper.go) 
